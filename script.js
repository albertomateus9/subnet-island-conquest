const PROJECT = {
  "code": "L-03",
  "slug": "subnet-island-conquest",
  "title": "Conquista das Ilhas de Sub-redes",
  "tagline": "Conquiste ilhas planejando CIDR, VLSM, VLANs e faixas de hosts.",
  "description": "Jogo de sub-redes em que equipes conquistam ilhas ao distribuir faixas IP, VLANs e rotas sem sobreposição.",
  "discipline": "Redes, Lógica e Planejamento de Infraestrutura",
  "visual": "islands",
  "accent": "#047857",
  "accent2": "#0891b2",
  "topics": [
  ...
  "guide": {
    "objective": "Treinar endereçamento IP como uma disputa por territórios bem planejados.",
    "prep": "Mostre um exemplo simples de CIDR e combine que sobreposição perde pontos.",
    "conduct": "Peça que cada equipe defenda sua escolha de faixa antes de avançar.",
    "closing": "Compare desperdício, capacidade e organização das tabelas propostas."
  },
  "missions": [
    {
      "id": "base",
      "title": "Conquistar a Ilha Base",
      "duration": 7,
      "points": 10,
      "story": "A escola precisa de uma rede base para administração e serviços do laboratório.",
      "challenge": "Escolher um bloco CIDR que suporte 30 hosts sem desperdiçar espaço demais.",
      "hint": "Conte hosts utilizáveis e escolha o menor bloco seguro.",
      "deliverable": "Escolha CIDR e quantidade de hosts utilizáveis.",
      "criterion": "Pontue cálculo correto e justificativa do tamanho escolhido."
    },
    {
      "id": "vlans",
      "title": "Construir Pontes VLAN",
      "duration": 8,
      "points": 15,
      "story": "Três ilhas precisam de separação: estudantes, professores e visitantes.",
      "challenge": "Atribuir VLAN e faixa de rede para cada ilha sem sobreposição.",
      "hint": "Separe primeiro por finalidade, depois calcule as faixas.",
      "deliverable": "Tabela de VLANs.",
      "criterion": "Pontue separação lógica, ausência de conflito e documentação clara."
    },
    {
      "id": "rota",
      "title": "Abrir a Rota Segura",
      "duration": 9,
      "points": 20,
      "story": "Uma rota está bloqueada porque duas ilhas usam faixas conflitantes.",
      "challenge": "Encontrar a sobreposição e propor uma sub-rede corrigida.",
      "hint": "Compare ID da rede e limite final de hosts utilizáveis.",
      "deliverable": "Tabela de planejamento IP corrigida.",
      "criterion": "Pontue identificação do conflito e correção sem criar novo conflito."
    }
  ],
  "fantasy": "Arquipélago de redes onde cada ilha precisa de faixa IP, VLAN e rota sem conflito.",
  "playerVerb": "conquistar ilhas",
  "layout": "map",
  "sceneLabels": [
    "Ilha Base",
    "VLAN Alunos",
  ...
  "hud": {
    "status": "Mapa de conquista",
    "primary": "Ilha selecionada",
    "secondary": "Risco de sobreposição",
    "token": "Bandeira"
  },
  "mechanic": {
    "title": "Mecânica da rodada",
    "prompt": "A equipe conquista uma ilha quando defende um bloco CIDR/VLSM sem sobrepor outras faixas.",
    "reward": "Ilha conquistada"
  },
  "teacherPrompt": "Peça que as equipes levantem bandeiras somente depois de calcular faixa, hosts e separação lógica.",
  "rewardLabel": "Ilhas conquistadas",
  "exportBase": "relatorio-ilhas-sub-redes",
  "csvBase": "placar-ilhas-sub-redes"
};
const RUBRICA = [
  {
